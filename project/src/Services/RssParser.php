...
class RssParser
{
    ...
    private array $categoryMapping = [
        'development' => ['php', 'javascript', 'python', 'java', 'c++', 'c#', 'ruby', 'go', 'rust', 'web', 'frontend', 'backend', 'фреймворк', 'laravel', 'symfony', 'react', 'vue', 'angular', 'разработка', 'программирование', 'разработчик', 'код', 'api', 'git'],
        'database' => ['sql', 'mysql', 'postgresql', 'sqlite', 'mongodb', 'redis', 'база данных', 'бд', 'данные'],
        'devops' => ['docker', 'kubernetes', 'ci/cd', 'devops', 'gitlab', 'jenkins', 'ansible', 'terraform', 'облако', 'cloud', 'aws', 'azure', 'контейнер', 'deploy'],
        'mobile' => ['ios', 'android', 'swift', 'kotlin', 'flutter', 'react native', 'мобильное', 'мобильный'],
        'gamedev' => ['игра', 'game', 'unity', 'unreal', 'геймдев', 'игровая', 'игровой'],
        'security' => ['безопасность', 'security', 'хакер', 'уязвимость', 'вирус', 'защита', 'взлом', 'ddos', 'эксплойт', 'утечка'],
        'hardware' => ['процессор', 'видеокарта', 'ram', 'ssd', 'ноутбук', 'компьютер', 'железо', 'gpu', 'cpu', 'intel', 'amd', 'nvidia', 'монитор', 'клавиатура', 'мышь'],
        'ai' => ['нейросеть', 'искусственный интеллект', 'ai', 'machine learning', 'ml', 'chatgpt', 'gpt', 'llm', 'нейронная сеть', 'claude', 'copilot', 'ии'],
        'science' => ['наука', 'исследование', 'учёный', 'открытие', 'космос', 'физика', 'биология', 'технология', 'квантовый'],
        'business' => ['бизнес', 'стартап', 'инвестиции', 'рынок', 'компания', 'startup', 'акции', 'финансы', 'контракт'],
    ];
